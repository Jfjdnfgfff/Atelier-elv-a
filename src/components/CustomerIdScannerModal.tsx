        ...
        {extractedData ? (
          ...
          >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                <div>
                  <label className="block text-[11px] font-black text-blue-900 mb-1 flex items-center gap-1">
                    ...
                    <span>اسم ولقب الزبونة / الزبون * (حروف فقط)</span>
                  </label>
                  <LettersInput
                    required
                ...
                <div>
                  <label className="block text-[11px] font-black text-blue-900 mb-1 flex items-center gap-1">
                    ...
                    <span>رقم بطاقة التعريف / NIN (أرقام فقط)</span>
                  </label>
                  <NumbersInput
              ...
              {(extractedData.birthDate || extractedData.address) && (
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 pt-1 border-t border-slate-200/60">
                  {extractedData.birthDate && (
                    <div>
                      <span className="block text-[10px] text-slate-500 font-bold flex items-center gap-1">
            ...
            <div className="grid grid-cols-2 gap-2 pt-1">
              <button
                type="submit"
                className="py-3 bg-blue-600 hover:bg-blue-700 active:scale-95 text-white rounded-2xl font-black text-xs sm:text-sm shadow-md shadow-blue-200 transition-all flex items-center justify-center gap-1.5"
              >
              ...
              <button
                ...
                className="py-3 bg-blue-50 hover:bg-blue-100 active:scale-95 text-blue-900 rounded-2xl font-bold text-xs transition-all flex items-center justify-center gap-1 border border-blue-200"
              >
                ...
                {activeTab === 'id_card' ? (
                  ...
                  >
                    <div className="flex justify-between items-start">
                      <span className="text-[10px] font-bold text-blue-50 bg-black/80 px-2 py-0.5 rounded-md border border-blue-500/30 flex items-center gap-1">
                        <CreditCard className="w-3 h-3 text-blue-400" />
                        <span>وجّه الكاميرا نحو بطاقة الهوية</span>
                      </span>
                    </div>
                    ...
                    <span className="text-[9px] font-bold text-blue-300 bg-black/75 px-2 py-0.5 rounded self-center flex items-center gap-1">
                      <Zap className="w-2.5 h-2.5 text-blue-400" />
                      <span>مسح فوري للباركود الخلفي أو اضغط الزر</span>
                    </span>
                  </div>
                ) : (
                  /* Barcode Viewfinder */
                  ...
                  >
                    ...
                    />
                    <span className="absolute top-1.5 right-2 text-[9px] font-mono font-black text-blue-300 bg-black/80 px-2 py-0.5 rounded-md flex items-center gap-1">
                      <Zap className="w-2.5 h-2.5 text-blue-400" />
                      <span>مسح فوري (0.01s)</span>
                    </span>
                  </div>
                )}
              </div>
              ...
              {(isInitializing || isProcessingAI) && (
                <div className="absolute inset-0 bg-slate-900/90 flex flex-col items-center justify-center text-white text-xs font-bold gap-2.5 z-30 p-4 text-center">
                  <div className="relative flex items-center justify-center">
                    ...
                    <Zap className="w-4 h-4 text-blue-400 absolute" />
                  </div>
                  <span className="text-blue-100 font-black flex items-center gap-1">
                    <Sparkles className="w-3.5 h-3.5 text-blue-400 animate-pulse" />
                    <span>{isProcessingAI
                      ? 'جاري استخراج الاسم ورقم التعريف فوراً...'
                      : 'تشغيل الكاميرا المباشرة...'}</span>
                  </span>
                </div>
              )}
