          ...
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              >
                ...
                <span className="hidden sm:inline text-[10px] sm:text-xs font-bold whitespace-nowrap">مسح الباركود</span>
              </button>
              ...
              <button
                ...
                className={`h-7 sm:h-9 w-7 sm:w-auto px-0 sm:px-3 justify-center shrink-0 rounded-lg sm:rounded-xl flex items-center gap-1 sm:gap-1.5 transition-all active:scale-95 text-[11px] sm:text-xs font-bold border group ${
                  hideFinances 
              ...
              >
                ...
                <span className="hidden sm:inline text-[10px] sm:text-xs font-bold whitespace-nowrap">{hideFinances ? 'إظهار المبالغ' : 'إخفاء المبالغ'}</span>
              </button>
              ...
              >
                ...
                <span className="hidden sm:inline text-[10px] sm:text-xs font-bold whitespace-nowrap">التقرير الشامل</span>
              </button>

              <button 
                onClick={goCaisse} 
                title="صندوق اليومية ومتابعة العجز (La Caisse)"
                aria-label="الصندوق اليومي"
                className={`h-7 sm:h-9 w-7 sm:w-auto px-0 sm:px-3 justify-center shrink-0 flex items-center gap-1 sm:gap-1.5 text-[11px] sm:text-xs font-bold rounded-lg sm:rounded-xl transition-all border active:scale-95 group ${
                  currentView === 'caisse'
              ...
              >
                ...
                <span className="hidden sm:inline text-[10px] sm:text-xs font-bold whitespace-nowrap">الصندوق اليومي</span>
              </button>
            </div>
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
              ...
              >
                ...
                <span className="hidden sm:inline text-[11px] sm:text-xs whitespace-nowrap">كراء جديد</span>
              </button>
            </div>
          </div>
